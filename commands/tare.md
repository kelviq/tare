...
argument-hint: [usage | window | report | tools | week | share | a question]
---
...
empty means the full diagnosis for the last 30 days; `usage`, `window`,
`report`, `tools`, `week` and `share` are the light paths; anything else
